...
interface NoticeRepository : JpaRepository<Notice?, Long?> {
    ...
    fun findForDetail(@Param("noticeId") id: Long?): java.util.Optional<Notice?>?
    ...
    fun findForUpdate(@Param("noticeId") id: Long?): java.util.Optional<Notice?>?
    ...
    fun findForDelete(@Param("noticeId") id: Long?): java.util.Optional<Notice?>?
